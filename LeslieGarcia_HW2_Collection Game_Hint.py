...
@Assignment: HINT - Homework #2 - Collection Game
...
@Description: HINT VERSION
###Build a program using: Dictionaries for metadata, Lists to hold collections,User-defined functions, Loops and logic control, and Type checking
...
def guessing_game(collection1, collection2, player1, player2):
    ...
    for turn in range(max_guesses):
        print(f"\n--- Turn [turn+1 ---")
        #HINT for player 1
        print("Hint: You are going to guess an item from the collection", collection2.keys())
        ...
        #HINT for player 2
        print("Hint: You are going to guess an item from the collection", collection1.keys())
